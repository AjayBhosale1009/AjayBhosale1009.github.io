...
<head>
    ...
    <link rel="icon" href="img/icons8-speech-bubble-avantgarde-32.png" sizes="32x32" type="image/png">

    <!-- <link rel="icon" href="/docs/5.2/assets/img/favicons/favicon-16x16.png" sizes="16x16" type="image/png"> -->
    <link rel="icon" href="img/icons8-speech-bubble-avantgarde-16.png" sizes="16x16" type="image/png">
    ...
    <main>
        <div class="position-relative overflow-hidden p-3 p-md-5 m-md-3 text-center bg-light">
            <div class="col-md-5 p-lg-5 mx-auto my-5">
                ...
                <p class="lead fw-normal">Chat with your friends without worrying about the privacy leaks. Now you can freely chat with your friends using our free platform</p>
